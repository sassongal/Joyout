...
# JoyaaS Installation Script
# This script sets up the JoyaaS platform for development and production

set -e

echo "🚀 Installing JoyaaS Platform..."
echo "================================="
...
DATABASE_URL=sqlite:///joyaas.db

# Google AI Configuration
GOOGLE_AI_API_KEY=

# Optional: Production configurations
# DATABASE_URL=postgresql://user:password@localhost:5432/joyaas
...
if [ "$CREATE_DEMO" = "y" ] || [ "$CREATE_DEMO" = "Y" ]; then
    python3 -c "
from joyaas_app import app, db, User
with app.app_context():
    # Check if demo user already exists
    demo_user = User.query.filter_by(username='demo').first()
    if not demo_user:
        demo_user = User(
            email='demo@joyaas.com',
            username='demo'
        )
...
echo "   gunicorn -w 4 -b 0.0.0.0:5000 joyaas_app:app"
echo ""
echo "🧪 Run tests:"
echo "   pytest"
echo ""
echo "📊 Database management:"
echo "   python3 -c \"from joyaas_app import app, db; app.app_context().push(); db.create_all()\""
echo ""
...
echo ""
echo "🎯 JoyaaS Features:"
echo "   ✓ Hebrew Nikud Addition"
echo "   ✓ Language Correction (Hebrew/English)"
echo "   ✓ Smart Translation"
echo "   ✓ Keyboard Layout Fixer"
echo "   ✓ Text Cleaner"
